...
module.exports = (function() {
  ...
  // Instance of LivePg, to be initialized on first request
  ...
  var adapter = {
    ...
    liveFind: function(connectionName, table, options, condition) {
      ...
      if(liveConnection === null) {
        // Open LivePg connection if not yet open
        liveConnection = new LivePg(
          connectionObject.config.url, connectionObject.config.channel);
      }
      ...
      if(typeof condition === 'function') {
        triggers[schema[collectionName].tableName] = condition;
      }
